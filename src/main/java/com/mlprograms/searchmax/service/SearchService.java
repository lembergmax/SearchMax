...
public final class SearchService {
    ...
    public void search(final String folderPath, final String queryText, final List<String> drives, final SearchEventListener listener, final boolean caseSensitive, final List<String> extensions, final List<String> includes, final java.util.Map<String,Boolean> includesCase, final List<String> excludes, final java.util.Map<String,Boolean> excludesCase) {
        if (listener == null) {
            throw new IllegalArgumentException("listener darf nicht null sein");
        }
        if (drives != null && !drives.isEmpty()) {
            handleSearchSelectedDrives(drives, queryText, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
            return;
        }
        ...
        if (folderPath != null) {
            ...
            if (trimmed.length() == 1 && Character.isLetter(trimmed.charAt(0))) {
                handleSearchSelectedDrives(trimmed, queryText, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
                return;
            }
        }

        if ("*".equals(folderPath)) {
            handleSearchAllDrives(queryText, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
            return;
        }

        if (isDriveList(folderPath)) {
            handleSearchSelectedDrives(folderPath, queryText, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
            return;
        }

        startSearch(folderPath, queryText, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
    }
    ...
    private void handleSearchAllDrives(final String queryText, final SearchEventListener listener, final boolean caseSensitive, final List<String> extensions, final List<String> includes, final java.util.Map<String,Boolean> includesCase, final List<String> excludes, final java.util.Map<String,Boolean> excludesCase) {
        ...
        for (final File root : roots) {
            ...
            if (Files.exists(rootPath)) {
                startSearchTask(searchId, rootPath, queryText, sharedHandle, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
            } else {
    ...
    private void handleSearchSelectedDrives(final String folderPathList, final String queryText, final SearchEventListener listener, final boolean caseSensitive, final List<String> extensions, final List<String> includes, final java.util.Map<String,Boolean> includesCase, final List<String> excludes, final java.util.Map<String,Boolean> excludesCase) {
    ...
    private void handleSearchSelectedDrives(List<String> drives, String queryText, SearchEventListener listener, boolean caseSensitive, final List<String> extensions, final List<String> includes, final java.util.Map<String,Boolean> includesCase, final List<String> excludes, final java.util.Map<String,Boolean> excludesCase) {
        if (drives == null || drives.isEmpty()) {
            listener.onError("Keine Laufwerke angegeben");
            return;
        }
    ...
    private void startSearch(final String folderPath, final String queryText, final SearchEventListener listener, final boolean caseSensitive, final List<String> extensions, final List<String> includes, final java.util.Map<String,Boolean> includesCase, final List<String> excludes, final java.util.Map<String,Boolean> excludesCase) {
        ...
        startSearchTask(searchId, startPath, queryText, handle, listener, caseSensitive, extensions, includes, includesCase, excludes, excludesCase);
    }
    ...
    private void startSearchTask(final String id, final Path startPath, final String queryText, final SearchHandle searchHandle, final SearchEventListener listener, final boolean caseSensitive, final List<String> extensions, final List<String> includes, final java.util.Map<String,Boolean> includesCase, final List<String> excludes, final java.util.Map<String,Boolean> excludesCase) {
        ...
        ForkJoinTask<?> submitted = pool.submit(() -> {
            try {
                pool.invoke(new DirectoryTask(startPath, results, matchCount, queryText, searchHandle.getStartNano(), onMatch, searchHandle.getCancelled(), caseSensitive, extensions, includes, includesCase, excludes, excludesCase));
            } catch (Throwable t) {
